...
module.exports = {
  upgrade: function () {
    var _upgrade = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(ctx, next) {
      var _ctx$request$query, code, version, fileList, apkHashName, index, element, filePath, DownloadUrl, is, apk, appInfo, _fs$statSync, size, buffer, hash, md5, initJson, check;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              filePath = _path["default"].join(_s_file.PUBLIC_DIR, apkHashName); // 合并后的文件写入的位置
